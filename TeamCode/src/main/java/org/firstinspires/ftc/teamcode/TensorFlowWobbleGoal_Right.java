...
@Autonomous(name = "Concept: TensorFlow Object Detection Right", group = "Concept")
//  @Disabled
public class TensorFlowWobbleGoal_Right extends LinearOpMode {
    ...
    @Override public void runOpMode() {
        ...
        robot.setPowerOfAllMotorsToForTime(.3, 2);
        if (opModeIsActive()) {
            robot.timer.reset();
            while (opModeIsActive()) {
                ...
                if(objectCode.equalsIgnoreCase(LABEL_NO_ELEMENT)){
                    ...
                    robot.setPowerOfAllMotorsToForTime(.6, 2.0 );
                    ...
                    robot.setPowerOfAllMotorsToForTime(.7,1 );
                    // Turn left
                    robot.turnLeftForTime(-.4,1.8 );
